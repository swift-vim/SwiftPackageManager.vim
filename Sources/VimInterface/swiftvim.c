...
extern const char *PLUGIN_FUNC(VIM_PLUGIN_NAME, _plugin_user_event)(int, const char *);
...
static PyObject *PLUGIN_FUNC(VIM_PLUGIN_NAME, _event)(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "is", &event, &ctx)) {
        ...
        result = (void *)PLUGIN_FUNC(VIM_PLUGIN_NAME, _plugin_user_event)(-1, "error parse");
    } else {
        result = (void *)PLUGIN_FUNC(VIM_PLUGIN_NAME, _plugin_user_event)(event, ctx);
    }
